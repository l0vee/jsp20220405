...
application.setAttribute("attr1","appliation attribute1");

request.setAttribute("attr2","request attribute2");
session.setAttribute("attr2","session attribute2");
application.setAttribute("attr2","appliation attribute2");

session.setAttribute("attr3","session attribute3");
application.setAttribute("attr3","appliation attribute3");

application.setAttribute("attr4","appliation attribute4");
